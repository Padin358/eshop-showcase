...
export default function Shop() {
  ...
  if (param) {
    return <>
      <div className="bg-bg transition-all duration-500">
        <Navbar />
        <div className="h-full w-full bg-[url(../img/bgImg.jpg)] bg-position-[center_top_-10rem] py-16">
          <h1 className="text-primary font-black text-7xl text-center">Bizon</h1>
          <h2 className="font-bold text-xl text-center">Pivo českých vlastenců</h2>
        </div>
