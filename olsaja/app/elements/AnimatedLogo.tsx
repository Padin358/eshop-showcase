...
const AnimatedLogo = () => {
  ...
  useEffect(() => {
    ...
    const timer2 = setTimeout(() => {
      ...
      setbizonClass(`w-64 mx-auto transition-all duration-1000 hover:scale-110 hover:rotate-10 opacity-100 drop-shadow-primary drop-shadow-md`)
    }, 4000);

    const timer3 = setTimeout(() => {
      setbizonClass("w-64 mx-auto transition-all duration-1000 opacity-0 drop-shadow-primary drop-shadow-md")
    }, 3000)
